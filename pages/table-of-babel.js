	...
	render() {
		return <div className="TableOfBabelPage">
			...
			<ul>
				...
				<li><b>Collaboration.</b> Wiki-style editing would be great. Currently the data is stored in a <a href="https://github.com/1j01/isaiahodhner.io/blob/main/src/table-of-babel-data.tsx">TSX file</a> (Typescript with JSX), and you can <a href="https://github.com/1j01/isaiahodhner.io/fork">fork my website</a> and submit a pull request to add or edit entries.</li>
